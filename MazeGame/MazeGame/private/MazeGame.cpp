...
void EjercicioNumero1()
{
    ...
    mapOfDoors[new Transform{ 3, 1 }] = new Door(Transform(3, 1));

    maze->AddRoom(Transform(2, 1));
    maze->AddRoom(Transform(5, 1));
...
void EjercicioNumero2(MazeFactory& const MazeFactory)
{
